...
type Program struct {
	...
	xxx_hidden_CloseSession    bool                   `protobuf:"varint,2,opt,name=close_session,json=closeSession"`
...
func (x *Program) GetCloseSession() bool {
	if x != nil {
		return x.xxx_hidden_CloseSession
	}
	return false
}
...
func (x *Program) SetCloseSession(v bool) {
	x.xxx_hidden_CloseSession = v
...
func (x *Program) HasCloseSession() bool {
	if x == nil {
		return false
	}
...
func (x *Program) ClearCloseSession() {
	protoimpl.X.ClearPresent(&(x.XXX_presence[0]), 1)
	x.xxx_hidden_CloseSession = false
}
...
func (b0 Program_builder) Build() *Program {
	...
	if b.CloseSession != nil {
		...
		x.xxx_hidden_CloseSession = *b.CloseSession
	}
	return m0
}
...
var file_program_proto_rawDesc = string([]byte{
	...
	,
