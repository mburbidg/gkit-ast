...
// Deprecated: Use SessionCloseCommand.ProtoReflect.Descriptor instead.
func (*SessionCloseCommand) Descriptor() ([]byte, []int) {
	return file_session_commands_proto_rawDescGZIP(), []int{0}
}
...
// Deprecated: Use SessionResetCommand.ProtoReflect.Descriptor instead.
func (*SessionResetCommand) Descriptor() ([]byte, []int) {
	return file_session_commands_proto_rawDescGZIP(), []int{1}
}
...
// Deprecated: Use SessionSetCommand.ProtoReflect.Descriptor instead.
func (*SessionSetCommand) Descriptor() ([]byte, []int) {
	return file_session_commands_proto_rawDescGZIP(), []int{2}
}
...
var file_session_commands_proto_rawDesc = string([]byte{
	...
	0x64, 0x73, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x12, 0x03, 0x61, 0x73, 0x74, 0x22, 0x15, 0x0a,
	0x13, 0x53, 0x65, 0x73, 0x73, 0x69, 0x6f, 0x6e, 0x43, 0x6c, 0x6f, 0x73, 0x65, 0x43, 0x6f, 0x6d,
	0x6d, 0x61, 0x6e, 0x64, 0x22, 0x15, 0x0a, 0x13, 0x53, 0x65, 0x73, 0x73, 0x69, 0x6f, 0x6e, 0x52,
	0x65, 0x73, 0x65, 0x74, 0x43, 0x6f, 0x6d, 0x6d, 0x61, 0x6e, 0x64, 0x22, 0x13, 0x0a, 0x11, 0x53,
	0x65, 0x73, 0x73, 0x69, 0x6f, 0x6e, 0x53, 0x65, 0x74, 0x43, 0x6f, 0x6d, 0x6d, 0x61, 0x6e, 0x64,
	0x42, 0x06, 0x5a, 0x04, 0x2f, 0x61, 0x73, 0x74, 0x62, 0x06, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x33,
})

var (
	file_session_commands_proto_rawDescOnce sync.Once
	file_session_commands_proto_rawDescData []byte
)

func file_session_commands_proto_rawDescGZIP() []byte {
	file_session_commands_proto_rawDescOnce.Do(func() {
		file_session_commands_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_session_commands_proto_rawDesc), len(file_session_commands_proto_rawDesc)))
	})
	return file_session_commands_proto_rawDescData
}
